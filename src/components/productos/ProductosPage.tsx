  ...
  return (
    <div className="h-full flex flex-col bg-slate-100">
      <div className="shrink-0 bg-white border-b border-slate-200 shadow-sm">
        ...
        <div className="px-4 md:px-6 flex items-center gap-6 mt-1 border-t border-slate-100">
          <button
            onClick={() => setActiveTab("productos")}
            className={`pb-2.5 pt-3 text-xs font-bold uppercase tracking-wider border-b-2 transition-all cursor-pointer ${
              activeTab === "productos"
